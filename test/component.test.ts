...
describe('Component', () => {
  ...
  describe('saveToFile', () => {
    ...
    it('should throw error when trying to write to read-only file', () => {
      ...
      const component = new Component('Test', 'Description', 'Text', 1);
      expect(() => component.saveToFile(testFilePath)).toThrow('Failed to save component: EPERM: operation not permitted, open');
  ...
  describe('loadFromFile', () => {
    ...
    it('should throw error when trying to read from write-only file', () => {
      ...
      try {
        ...
        expect(() => Component.loadFromFile(testFilePath)).toThrow('Failed to load component: Error: EACCES: permission denied, open');
      } finally {
    ...
    it('should throw error for JSON missing required fields', () => {
      ...
      expect(() => Component.loadFromFile(testFilePath)).toThrow('Invalid component data in file');
    });
  });
